...
public abstract class VersionedGestureDetector {
	...
	private static class EclairDetector extends CupcakeDetector {
		...
		public boolean onTouchEvent(MotionEvent ev) {
			...
			Log.v("action","===========================mActivePointerIndex:"+mActivePointerIndex + " id:"+mActivePointerId+ "   :"+( (ev.getAction() & MotionEvent.ACTION_POINTER_INDEX_MASK) >> MotionEvent.ACTION_POINTER_INDEX_SHIFT) +" mLastTouchX:"+mLastTouchX +" mLastTouchY:"+mLastTouchY);
